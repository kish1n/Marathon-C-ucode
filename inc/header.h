#include "../resource/SDL2-2.30.0/include/SDL.h"
#include "../resource/SDL_mixer-2.8.0/include/SDL_mixer.h"
#include "../resource/SDL2_image-2.8.2/include/SDL_image.h"
#include "../resource/SDL2_ttf-2.22.0/include/SDL_ttf.h"
...
void main_event_handler(SDL_Event *event, SDL_Renderer* render, Object** first_rom_obj, int *len1, bool* isMenuOpen, bool* settingsOpened, bool* renderActiveObject, SDL_Texture** active_texture, SDL_Rect* active_position, Object* active_obj);
...
void win_buildFHD(SDL_Renderer* renderer, SDL_Window* window, SDL_Texture* backgroundTexture[], SDL_Texture* buttonTextures[], SDL_Texture* settingsButtonTextures[], SDL_Texture* authorsBackgroundTexture, SDL_Event e, bool inSettingsPage, bool inAuthorsPage);
void win_buildHD(SDL_Renderer* renderer, SDL_Window* window, SDL_Texture* backgroundTexture[], SDL_Texture* buttonTextures[], SDL_Texture* settingsButtonTextures[], SDL_Texture* authorsBackgroundTexture, SDL_Event e, bool inSettingsPage, bool inAuthorsPage);
void win_buildNHD(SDL_Renderer* renderer, SDL_Window* window, SDL_Texture* backgroundTexture[], SDL_Texture* buttonTextures[], SDL_Texture* settingsButtonTextures[], SDL_Texture* authorsBackgroundTexture, SDL_Event e, bool inSettingsPage, bool inAuthorsPage);
