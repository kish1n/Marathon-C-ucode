...
void init_texture_menu(SDL_Renderer* renderer, SDL_Texture* backgroundTexture[], SDL_Texture** authorsBackgroundTexture, SDL_Texture* buttonTextures[], SDL_Texture* settingsButtonTextures[]) {
    backgroundTexture[0] = load_texture("resource/menu/images/background.PNG", renderer);
    backgroundTexture[1] = load_texture("resource/menu/images/background2.PNG", renderer);
    backgroundTexture[2] = load_texture("resource/menu/images/background3.PNG", renderer);
    backgroundTexture[3] = load_texture("resource/menu/images/backgroundsettings.PNG", renderer);

    *authorsBackgroundTexture = load_texture("resource/menu/images/backgroundauthors.PNG", renderer);

    buttonTextures[0] = load_texture("resource/menu/images/button1.PNG", renderer);
    buttonTextures[1] = load_texture("resource/menu/images/button2.PNG", renderer);
    buttonTextures[2] = load_texture("resource/menu/images/button3.PNG", renderer);
    buttonTextures[3] = load_texture("resource/menu/images/button4.PNG", renderer);
